...
from garage.torch.algos import Causal_MTCAE
...
@click.option('--gpu', '_gpu', type=int, default=2)
@wrap_experiment(snapshot_mode='none')
def mtsac_metaworld_mt1_pick_place(ctxt=None, *, seed, timesteps, _gpu):
    """Train Causal MTCAE with the MT1 pick-place-v1 environment.
    ...
    mt1 = metaworld.MT1('soccer-v1')
    mt1_test = metaworld.MT1('soccer-v1')
    ...
    mtsac = Causal_MTCAE(policy=policy,
                  qf1=qf1,
                  qf2=qf2,
                  sampler=sampler,
